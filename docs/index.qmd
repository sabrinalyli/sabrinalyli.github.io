...
We know that YFV in Brazil is transmitted by *Haemagogus* mosquitoes and maintained by non-human primates which can transmit the virus amongst themselves. 
...
```{r}
#| label: fig-hg
#| fig-cap: "Haemagogus sampling locations in Horto Florestal"
#| fig-width: 6
#| fig-height: 3.5
#| echo: true 
#| output: true
...
- **Environmental data**: Environment and climate change plays a role in determining when and where mosquitoes may breed, reside, and feed. We can overlay environmental data such as temperature, precipitation, relative humidity, and elevation, to approximate potential habitat locations of *Haemagogus*. These factors strongly influence the habitats and occurrence of mosquitoes. When mapping, these data sets come in the form of rasters.
...
- **Geospatial modelling**: By integrating spatial information in machine learning models, we can predict the environmental suitability of *Haemagogus* (e.g. probability of seeing mosquito occurrence) across Brazil. 
